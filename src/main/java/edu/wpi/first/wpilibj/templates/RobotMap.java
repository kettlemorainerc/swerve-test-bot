...
public class RobotMap {
    ...
    public static final int encoder3ChannelA = 5;
    public static final int encoder3ChannelB = 6;
    
    public static final int encoder4ChannelA = 7;
    public static final int encoder4ChannelB = 8;
}
